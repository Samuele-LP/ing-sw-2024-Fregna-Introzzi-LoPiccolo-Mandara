...
public interface ClientSideMessageListener {
    ...
    /**
     *Message received when a player has correctly drawn a card. The controller should now block most of the messages the client is trying to send
     */
    ...
    /**
     *The client is notified that their turn has started so the expected response is either a PlaceCarMessage or a RequestAvailablePositionsMessage
     */
