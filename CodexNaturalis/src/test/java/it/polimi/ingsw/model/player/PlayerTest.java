...
public class PlayerTest {
    ...
    @Before
    public void setUp() throws IllegalStartingCardException, NotPlacedException, AlreadyPlacedException, NotEnoughResourcesException, CardNotInHandException, InvalidPositionException, HandAlreadyFullException {
